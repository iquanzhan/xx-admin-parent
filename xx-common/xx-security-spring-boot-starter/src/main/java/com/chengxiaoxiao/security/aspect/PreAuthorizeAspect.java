...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.chengxiaoxiao.security.annotation.RequiresLogin) || "
            + "@annotation(com.chengxiaoxiao.security.annotation.RequiresPermissions) || "
            + "@annotation(com.chengxiaoxiao.security.annotation.RequiresRoles)";
